    ...
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Card>(entity =>
            {
                ...
                entity.Property(c => c.CardId).HasColumnName("ID").ValueGeneratedOnAdd(); ;
            ...
            modelBuilder.Entity<Cart>(entity =>
            {
                ...
                entity.Property(c => c.CartId).HasColumnName("ID").ValueGeneratedOnAdd(); ;
                ...
                entity.Property(c => c.CreatedAt).HasColumnName("CREATED_AT").IsRequired(false);
                entity.Property(c => c.UpdatedAt).HasColumnName("UPDATED_AT").IsRequired(false);
            ...
            modelBuilder.Entity<EmailVerification>(entity =>
            {
                ...
                entity.Property(e => e.CanUsed).HasColumnName("CAN_USED").IsRequired();
            ...
            modelBuilder.Entity<OrderHistory>(entity =>
            {
                ...
                entity.Property(o => o.Token).HasColumnName("TOKEN").IsRequired(false);
